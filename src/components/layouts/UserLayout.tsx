        ...
        <div className="wedding-container py-4">
          <div className="flex justify-between items-center">
            ...
            <Link to="/user" className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-display font-semibold text-wedding-navy">WeddingVL</span>
            </Link>
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <Link 
                ...
                className={`text-gray-600 hover:text-wedding-navy transition-colors ${
                  isActive('/user') ? 'font-semibold text-wedding-navy' : ''
                }`}
              >
                Home
              </Link>
              <Link 
                to="/user/vendors" 
                className={`text-gray-600 hover:text-wedding-navy transition-colors ${
                  isActive('/user/vendors') ? 'font-semibold text-wedding-navy' : ''
                }`}
              >
                Find Vendors
              </Link>
              <Link 
                to="/user/bookings" 
                className={`text-gray-600 hover:text-wedding-navy transition-colors ${
                  isActive('/user/bookings') ? 'font-semibold text-wedding-navy' : ''
                }`}
              >
                My Bookings
              </Link>
      ...
      <footer className="bg-wedding-navy text-white py-8">
        <div className="wedding-container">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-semibold mb-4">WeddingVL</h3>
              <p className="text-gray-300">Your complete wedding planning solution.</p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-300 hover:text-white">Wedding Planning Tips</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white">Vendor Guides</a></li>
